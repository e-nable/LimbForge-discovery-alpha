var HandLoader = function(manifest,design){
  ...
  return {
    ...
    getFiles: function(hand,l1,c4,design,successCallback,errorCallback){
      var parts = getParts(hand,l1,c4,design);
      var files = [];
      ...
      _.each(parts,function(p){
        ...
        (function(){
          var partfilename = _.template(p.file_name_template)({handedness:hand,l1:l1,c4:c4});
          var partDirname = design.directory + _.template(p.file_dir_template)({handedness:hand,l1:l1,c4:c4});
